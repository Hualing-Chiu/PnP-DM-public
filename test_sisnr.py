...
logging.basicConfig(filename='/media/md01/home/hualing/PnP-DM-public/results_libritts_720k_3_spk/source_separation/each_sisnr.txt', level=logging.INFO, format='%(message)s')
...
if __name__=="__main__":
    original_path = "/media/md01/home/hualing/PnP-DM-public/results_libritts_720k_3_spk/source_separation/original"
    degraded_path = "/media/md01/home/hualing/PnP-DM-public/results_libritts_720k_3_spk/source_separation/degraded"
    generated_path = "/media/md01/home/hualing/PnP-DM-public/results_libritts_720k_3_spk/source_separation/generated"
    ...
    for i in tqdm(range(N)):
        ...
        generated_signals = [degraded_w, degraded_w, degraded_w]
